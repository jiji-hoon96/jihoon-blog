...
// 내려간 글의 슬러그와 그 자리를 대신할 글. 2026-09-21 에 관측 시리즈 네 편
// (260913~260916)을 전부 내리면서 통합본 260703 의 대상도 사라져 지금은 비어 있다.
// 다섯 슬러그 모두 404 로 나간다. Sentry 글을 다시 쓰면 260703 을 그 글로 돌린다.
//

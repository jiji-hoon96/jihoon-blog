...
const dictionaries: Record<Locale, Dictionary> = {
  ko: {
    ...
    post: { tableOfContents: '목차', openTableOfContents: '목차 열기', closeTableOfContents: '목차 닫기', relatedPosts: '함께 읽으면 좋은 글', previousPost: '이전 글', nextPost: '다음 글', comments: '댓글' },
  ...
  en: {
    ...
    post: { tableOfContents: 'Table of contents', openTableOfContents: 'Open table of contents', closeTableOfContents: 'Close table of contents', relatedPosts: 'Related posts', previousPost: 'Previous post', nextPost: 'Next post', comments: 'Comments' },
  ...
  ja: {
    ...
    post: { tableOfContents: '目次', openTableOfContents: '目次を開く', closeTableOfContents: '目次を閉じる', relatedPosts: '関連記事', previousPost: '前の記事', nextPost: '次の記事', comments: 'コメント' },
  ...
  es: {
    ...
    post: { tableOfContents: 'Índice', openTableOfContents: 'Abrir índice', closeTableOfContents: 'Cerrar índice', relatedPosts: 'Artículos relacionados', previousPost: 'Artículo anterior', nextPost: 'Artículo siguiente', comments: 'Comentarios' },
  ...
  'pt-BR': {
    ...
    post: { tableOfContents: 'Sumário', openTableOfContents: 'Abrir sumário', closeTableOfContents: 'Fechar sumário', relatedPosts: 'Artigos relacionados', previousPost: 'Artigo anterior', nextPost: 'Próximo artigo', comments: 'Comentários' },
  ...
  'zh-CN': {
    ...
    post: { tableOfContents: '目录', openTableOfContents: '打开目录', closeTableOfContents: '关闭目录', relatedPosts: '相关文章', previousPost: '上一篇', nextPost: '下一篇', comments: '评论' },

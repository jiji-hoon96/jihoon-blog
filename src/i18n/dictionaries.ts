...
const dictionaries: Record<Locale, Dictionary> = {
  ...
  ja: {
    ...
    home: { values: ['個性的な名前を持つだけで、個性的な人になれるとは思わない。自分がより深く考え、より良いものを作る人になれば、残すものも自然と自分らしいものになるはずだ。', 'ジフンを逆にして훈지と呼び始めたのも、そんな考えからだった。慣れた考えを少しだけ裏返すと、別の問いや視点が生まれる。ソフトウェアを作るときも、技術より先にユーザーが直面する問題を見て、当然に見える選択を問い直し、判断の理由を残そうとしている。', '良いソフトウェアは、複雑なコードを巧みに扱うだけでは終わらない。問題を一緒に理解するための言葉を作り、失敗を観察できるようにし、次の人がより良い判断をできるよう文脈を残すことだと信じている。', 'ここには、そうして違う角度から見て、作り、もう一度考えたことを記録する。書くことも、知っていることを整理するというより、自分が何を知らなかったのかを発見する過程に近い。'], greeting: 'こんにちは、{name}です', pinnedPosts: '注目の記事', noPinnedPosts: '注目の記事はまだありません。', recentPosts: '最新の記事', viewAll: 'すべての記事', noPosts: '記事はまだありません。' },

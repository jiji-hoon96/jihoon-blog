...
description: 'React 프로젝트에서 DatePicker를 고를 때마다 헤드리스, 번들 사이즈, 7개 primitive 중 한두 가지는 늘 포기해야 했다. 그래서 직접 만들었다. 약 16KB gzip, ISO 문자열 API, 어댑터 패턴까지 Kalyx의 4가지 핵심 결정을 정리한다.'

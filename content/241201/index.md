...
:::ref
- [docs] [Biome — Getting Started](https://biomejs.dev/guides/getting-started/)
- [repo] [rome/tools (Biome 전신)](https://github.com/rome/tools)
- [docs] [VS Code — Biome Extension](https://marketplace.visualstudio.com/items?itemName=biomejs.biome)
- [docs] [JetBrains — Biome Plugin](https://plugins.jetbrains.com/plugin/22761-biome)
:::

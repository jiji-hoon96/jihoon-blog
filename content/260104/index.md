...
description: 'TanStack Query의 queryKey가 어떤 원리로 동작하고 왜 인라인 배열에서 query key factory, queryOptions까지 진화해왔는지 정리한다. TkDodo 패턴과 v5 queryOptions, setQueryData 무효화를 실무 관점으로 다룬다.'

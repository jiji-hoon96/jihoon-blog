...
![Diagrama de fluxo de dados no React: os dados descem por props e os eventos sobem](3.png)
...
![Diagrama do padrão Flux: Action, Dispatcher, Store e View ligados em uma única direção](4.png)
